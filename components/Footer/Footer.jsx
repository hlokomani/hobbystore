...
const Footer = () => {
    return (
        <footer className="bg-lighter_brown py-7 px-8 font-sans tracking-wide border-t border-gray-200">
            <div className="flex max-lg:flex-col items-center justify-between gap-6">
                ...
                <ul className="flex flex-wrap justify-center gap-x-6 gap-4">
                    <li><a href="#" className="text-xl hover:text-gray-600">
                ...
                <ul className="flex gap-x-6 gap-y-2 flex-wrap">
                    <li><a href="#" className="text-gray-600 hover:text-black text-base">Terms of Service</a></li>
                    <li><a href="#" className="text-gray-600 hover:text-black text-base">Privacy Policy</a></li>
                    <li><a href="#" className="text-gray-600 hover:text-black text-base">Contact</a></li>
                </ul>
            </div>
        </footer>
    );
