            ...
            <div className='flex flex-wrap items-center lg:gap-y-2 gap-4 w-full'>
                ...
                <div className="flex gap-x-6 gap-y-4 ml-auto">
                    <div className='flex items-center space-x-8'>
                        ...
                        <button onClick={handleLogout} className='px-4 py-2 text-sm rounded-full font-bold text-white border-2 border-browner bg-browner transition-all ease-in-out duration-300 hover:bg-transparent hover:text-dark_brown'>
                            Logout
                        </button>
                    </div>
                </div>
