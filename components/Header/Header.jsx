...
const Header = () => {
    ...
    return (
        <header className='flex bg-white border-b py-4 sm:px-8 px-6 font-[sans-serif] min-h-[80px] tracking-wide relative z-50'>
            ...
            <a href="/products" className="text-black font-bold text-xl mr-5">
                HarmonyHub
            </a>
            ...
            <div id="collapseMenu"
                ...
                <ul
                    ...
                    <li className='max-lg:border-b max-lg:py-3 px-3'><a href='/products'
                        className='text-[#007bff] hover:text-[#007bff] text-[15px] block font-semibold'>Acoustic Guitars</a></li>
                    <li className='max-lg:border-b max-lg:py-3 px-3'><a href='/products'
                        className='text-[#333] hover:text-[#007bff] text-[15px] block font-semibold'>Electric Guitars</a></li>
                    <li className='max-lg:border-b max-lg:py-3 px-3'><a href='/products'
                        className='text-[#333] hover:text-[#007bff] text-[15px] block font-semibold'>Bas Guitars</a></li>
                    <li className='max-lg:border-b max-lg:py-3 px-3'><a href='/products'
                        className='text-[#333] hover:text-[#007bff] text-[15px] block font-semibold'>Ukuleles</a></li>
                </ul>
            </div>
            ...
            <div className="flex gap-x-6 gap-y-4 ml-auto">
                <div className='flex border-2 focus-within:border-gray-400 rounded-full px-6 py-3 overflow-hidden max-w-52 max-lg:hidden'>
                    <input type='text' placeholder='Search Here...' className='w-full text-sm bg-transparent outline-none pr-2' />
