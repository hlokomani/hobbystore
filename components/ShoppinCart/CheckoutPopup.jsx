...
const CheckoutPopup = () => {
  ...
  return (
    <div>
      <a href="#" onClick={togglePopup} className="flex w-full items-center justify-center rounded-lg bg-browner px-5 py-2.5 text-sm font-medium text-white hover:bg-dark_brown focus:outline-none focus:ring-4 focus:ring-browner dark:bg-browner dark:hover:bg-browner dark:focus:ring-browner">Proceed to Checkout</a>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="relative bg-white p-8 rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <form onSubmit={handleSubmit} className="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
              ...
              <button type="submit" className="flex w-full items-center justify-center rounded-lg bg-browner px-5 py-2.5 text-sm font-medium text-white hover:bg-dark_brown focus:outline-none focus:ring-4 focus:ring-browner dark:bg-browner dark:hover:bg-browner dark:focus:ring-browner">Pay now</button>
            </form>
          </div>
        </div>
      )}
